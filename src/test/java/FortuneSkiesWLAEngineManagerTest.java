...
public class FortuneSkiesWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(FortuneSkiesWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/FortuneSkiesWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/FortuneSkiesWLAIW/InitOutcome.xml").getDocumentElement();
